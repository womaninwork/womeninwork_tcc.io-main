...
CREATE TABLE `pagamento` (
  ...
  KEY `fk_pagamento_forma de pagamento1_idx` (`forma de pagamento_id_forma_de_pagamento`),
  CONSTRAINT `fk_pagamento_forma de pagamento1` FOREIGN KEY (`forma de pagamento_id_forma_de_pagamento`) REFERENCES `forma de pagamento` (`id_forma_de_pagamento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-26 12:16:04
